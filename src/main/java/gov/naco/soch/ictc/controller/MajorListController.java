...
public class MajorListController {
	...
	public ResponseEntity <List<NewICTCDto>> ictcCouncelling(
	  ...
	  @RequestParam(name = "sort", defaultValue = "id,desc") String[] sort){
    	...
    	List<NewICTCDto> page1= service.getQueryData(facilityIdEquals,beneficiaryStatusEquals,isPostTestCounsellingCompletedEquals, categoryIdNotEquals, page ,size,pid, pageable);
